...
public class GameEngine {
	...
	// The timer that runs the se.wizard.laststand.engine.
	...
	/**
	 * The se.wizard.laststand.engine will periodically progress the current
	...
	public void run() {
		if (currentLevel == null)
			throw new IllegalStateException(
					"No existing level in the se.wizard.laststand.engine");
		gameTicker.start();
	}
	...
	/**
	 * The Level the se.wizard.laststand.engine currently is progressing.
	 * 
	 * @return The Level the se.wizard.laststand.engine currently is
	 *         progressing.
	 */
